...
// Helper function to generate a complete series with multipliers
function generateCompleteSeries(baseValues, multipliers = [1, 10, 100, 1000, 10000, 100000, 1000000]) {
    const completeSeries = [];
    for (const multiplier of multipliers) {
        for (const value of baseValues) {
            completeSeries.push(value * multiplier);
        }
    }
    return completeSeries;
}

// Generate complete series for each standard
const completeResistorSeries = {
    E24: generateCompleteSeries(resistorSeries.E24),
    E48: generateCompleteSeries(resistorSeries.E48),
    E96: generateCompleteSeries(resistorSeries.E96),
    E192: generateCompleteSeries(resistorSeries.E192)
};

// Export the series
export { resistorSeries, completeResistorSeries }; 